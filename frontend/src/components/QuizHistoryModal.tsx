  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center p-2 sm:p-6">
      ...
      <motion.div
        ...
        className="relative w-full max-w-3xl max-h-[92vh] sm:max-h-[85vh] overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 bg-[#121212] shadow-[0_30px_100px_rgba(0,0,0,0.75)]"
      >
